	...
	namespace core
	{
		namespace io
		{
			namespace savers
			{
				...
				void JsonGameDataProcesser::inventoryToJson(json& json, characterstuff::Inventory& inventory) const
				{
				...
				std::unique_ptr<characterstuff::Inventory> JsonGameDataProcesser::loadInventory(json& saveFile)
				{
